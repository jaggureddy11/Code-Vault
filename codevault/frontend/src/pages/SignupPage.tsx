...
import { Activity, ArrowRight, ShieldCheck, Loader2, CheckCircle2, Mail, User, Lock } from 'lucide-react';
        ...
        <div className="w-full max-w-[460px] relative z-10 bg-white dark:bg-black p-8 sm:p-10 border-2 border-black dark:border-white rounded-none">
          ...
          <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              ...
              <div className="group">
                <label htmlFor="username" className="block text-[10px] font-black text-black/60 dark:text-white/60 uppercase tracking-[0.2em] mb-1.5 group-focus-within:text-black dark:group-focus-within:text-white transition-colors">
                  Username
                </label>
                <div className="relative flex items-center bg-transparent border-2 border-black/20 dark:border-white/20 group-focus-within:border-black dark:group-focus-within:border-white transition-colors duration-200 overflow-hidden rounded-none">
                  <div className="pl-3 pr-2 text-black/40 dark:text-white/40 group-focus-within:text-black dark:group-focus-within:text-white transition-colors duration-200">
              ...
              <div className="group">
                <label htmlFor="confirmPassword" className="block text-[10px] font-black text-black/60 dark:text-white/60 uppercase tracking-[0.2em] mb-1.5 group-focus-within:text-black dark:group-focus-within:text-white transition-colors">
                  Confirm Password
                </label>
                <div className="relative flex items-center bg-transparent border-2 border-black/20 dark:border-white/20 group-focus-within:border-black dark:group-focus-within:border-white transition-colors duration-200 overflow-hidden rounded-none">
                  <div className="pl-3 pr-2 text-black/40 dark:text-white/40 group-focus-within:text-black dark:group-focus-within:text-white transition-colors duration-200">
            ...
            <div className="pt-2 space-y-3">
              ...
              >
                {loading && !isSuccess ? (
                  ...
                  <>
                    Sign Up <ArrowRight className="h-6 w-6 stroke-[3px] group-hover:translate-x-2 transition-transform" />
                  </>
                )}
              </Button>
